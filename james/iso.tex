...
On va maintenant munir $\James{p}$ d'une nouvelle norme, équivalente à celle qu'on lui a mise précédemment. La norme sera la suivante:
...
Puisqu'on a une base de Schauder monotone contractante on peut, par le théorème (\ref{dualisometriqueschauder}), identifier isométriquement le bidual de $(\James{p},\normeJamesI{p}{.})$ à l'espace 
\[
